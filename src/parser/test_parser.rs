                ...
                ImplFunction::Function(Function {
                    ...
                    body: vec![
                        Statement::new_return(
                            ...
                            Some(Box::new(
                                Expression::new_literal(Literal::new_i32(
                                    ttoken(TokenType::I32Literal, "0i32", "0"),
                                    0i32
                                )))
                            )
                        ),
                    ...
                    body: vec![
                        ...
                        Statement::new_return(
                            ...
                            Some(Box::new(Expression::new_struct_initializer(
                                ...
                                tidentifier("TestA"),
                                vec![
                                    (tidentifier("a"), Expression::new_literal(
                                        Literal::new_i32(
                                            ttoken(TokenType::I32Literal, "3i32", "3"),
                                            3i32
                                        )
                                    )),
                                ],
